...
function refreshAccessToken(){
   ...
   /*This will run refreshAccessToken() function for obataing a new access token automaticly 
   after 3600 seconds = 3 600 000 ms - 600 000 ms  = 60 min - 10 min  --> 50 minutes*/
...
function callAuthorizationApi(body){
  ...
  /*This function will save the fetched access and refresh token from spotify to a coockie
   and given variables under.*/
...
//This function will clear the url from sensetive information after redirect from spotify after auth proccess.
...
//This function will log out and redirect the user to loging page.
function logOut(){
